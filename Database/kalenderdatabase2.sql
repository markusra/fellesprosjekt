...
-- -----------------------------------------------------
-- Table `kalenderdatabase`.`MØTEROM`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kalenderdatabase`.`MØTEROM` (
  `møteromID` INT NOT NULL AUTO_INCREMENT,
  `sted` VARCHAR(45) NULL,
  `størrelse` INT NOT NULL,
  `start` VARCHAR(45) NOT NULL,
  `slutt` VARCHAR(45) NOT NULL,
  `navn` VARCHAR(45) NULL,
  PRIMARY KEY (`møteromID`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `kalenderdatabase`.`AVTALE` (
  ...
  INDEX `fk_AVTALE_MØTEROM1_idx` (`møteromID` ASC),
  ...
  CONSTRAINT `fk_AVTALE_MØTEROM1`
    FOREIGN KEY (`møteromID`)
    REFERENCES `kalenderdatabase`.`MØTEROM` (`møteromID`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB;
